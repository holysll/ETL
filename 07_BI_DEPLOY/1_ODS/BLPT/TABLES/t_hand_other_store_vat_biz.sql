DROP TABLE IF EXISTS ODS_BLPT.`T_HAND_OTHER_STORE_VAT_BIZ`;
CREATE TABLE ODS_BLPT.`T_HAND_OTHER_STORE_VAT_BIZ` (
...
DROP TABLE IF EXISTS ODS_BLPT.`STG_T_HAND_OTHER_STORE_VAT_BIZ`;
CREATE TABLE ODS_BLPT.`STG_T_HAND_OTHER_STORE_VAT_BIZ` (
  `ID`               BIGINT         COMMENT 'AUTO_INCREMENT',
  `SEQ_ID`           STRING         COMMENT '序号ID',
  `MONTH_ID`         STRING         COMMENT '月份ID',
  `RGN_NAME`         STRING         COMMENT '大区名称',
...
DROP TABLE IF EXISTS ODS_BLPT.`HIS_T_HAND_OTHER_STORE_VAT_BIZ`;
CREATE TABLE ODS_BLPT.`HIS_T_HAND_OTHER_STORE_VAT_BIZ` (
  `ID`               BIGINT         COMMENT 'AUTO_INCREMENT',
  `SEQ_ID`           STRING         COMMENT '序号ID',
  `MONTH_ID`         STRING         COMMENT '月份ID',
  `RGN_NAME`         STRING         COMMENT '大区名称',
