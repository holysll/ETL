DROP TABLE IF EXISTS ODS_BLPT.`T_HAND_ACCTS_RCVBL`;
CREATE TABLE ODS_BLPT.`T_HAND_ACCTS_RCVBL` (
...
DROP TABLE IF EXISTS ODS_BLPT.`STG_T_HAND_ACCTS_RCVBL`;
CREATE TABLE ODS_BLPT.`STG_T_HAND_ACCTS_RCVBL` (
  `ID`               BIGINT         COMMENT 'AUTO INCREMENT',
  `SEQ_ID`           STRING         COMMENT '序号ID',
  `YEAR_ID`          STRING         COMMENT '年份ID',
  `RGN_NAME`         STRING         COMMENT '大区名称',
...
DROP TABLE IF EXISTS ODS_BLPT.`HIS_T_HAND_ACCTS_RCVBL`;
CREATE TABLE ODS_BLPT.`HIS_T_HAND_ACCTS_RCVBL` (
  `ID`               BIGINT         COMMENT 'AUTO INCREMENT',
  `SEQ_ID`           STRING         COMMENT '序号ID',
  `YEAR_ID`          STRING         COMMENT '年份ID',
  `RGN_NAME`         STRING         COMMENT '大区名称',
