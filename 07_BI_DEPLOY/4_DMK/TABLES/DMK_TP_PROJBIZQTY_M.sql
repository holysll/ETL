DROP TABLE IF EXISTS DMK.DMK_TP_PROJBIZQTY_M;
CREATE TABLE IF NOT EXISTS DMK.DMK_TP_PROJBIZQTY_M(
...
BIZ_QTY                       BIGINT                             COMMENT  '运输业务量',
BIZ_NUM                       BIGINT                             COMMENT  '运输总量次',
