DROP TABLE IF EXISTS DIM.DIM_BIZATTR;
CREATE TABLE IF NOT EXISTS DIM.DIM_BIZATTR(
BIZATTR_ID                    STRING                             COMMENT  '业务属性ID',
BIZATTR_NAME                  STRING                             COMMENT  '业务属性名称',
...
DROP TABLE IF EXISTS DIM.HIS_DIM_BIZATTR;
CREATE TABLE IF NOT EXISTS DIM.HIS_DIM_BIZATTR(
BIZATTR_ID                    STRING                             COMMENT  '业务属性ID',
BIZATTR_NAME                  STRING                             COMMENT  '业务属性名称',
SOURCE_CODE                   STRING                             COMMENT  '来源',
WD_INSERT_DT                  STRING                             COMMENT  '数据仓库记录插入时间 ',
