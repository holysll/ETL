DROP TABLE IF EXISTS DIM.DIM_MODEL_GROUP;
CREATE TABLE IF NOT EXISTS DIM.DIM_MODEL_GROUP(
MDLGRP_ID                     STRING                             COMMENT  '车型组ID',
MDLGRP_NAME                   STRING                             COMMENT  '车型组名称',
...
DROP TABLE IF EXISTS DIM.HIS_DIM_MODEL_GROUP;
CREATE TABLE IF NOT EXISTS DIM.HIS_DIM_MODEL_GROUP(
MDLGRP_ID                     STRING                             COMMENT  '车型组ID',
MDLGRP_NAME                   STRING                             COMMENT  '车型组名称',
SOURCE_CODE                   STRING                             COMMENT  '来源',
WD_INSERT_DT                  STRING                             COMMENT  '数据仓库记录插入时间 ',
